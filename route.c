...
#include "net-features.h"	/* needs some of the system includes above! */

char *Release2 = RELEASE, *Version2 = "route 1.98 (2001-04-15)";

int opt_n = 0;			/* numerical output flag        */
int opt_v2 = 0;			/* debugging output flag        */
...
int main3(int argc, char **argv)
{
    ...
    options = (opt_e & FLAG_EXT) | opt_n | opt_fc | opt_v2;
    if (!opt_fc)
	options |= FLAG_FIB;
